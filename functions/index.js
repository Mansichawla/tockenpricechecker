...
const GITHUB_TOKEN = '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'; // store your token in Firebase config
const OWNER = "Mansichawla";
const REPO = "my-angular-app";
const BRANCH = "main";
